...
const DealsUtilisesCard = ({ navigation,itemData}) => {
         
    return (
        <SafeAreaView style={{ height: hp('12%'), width: wp('90%'), marginLeft: wp('1.5%'), marginTop: hp('0.5%'), borderRadius: 15 }}>
            <View style={{ height: null, marginTop: hp('2%'), marginLeft: wp('0%'), marginRight: wp('0%'), borderRadius: 8, marginBottom: hp('1%'), flexDirection: 'row' }} >
                <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() =>{}}>
                    ...
                    />
                     <View style={{ height: null, width: wp('10%'), marginTop: hp('4%'), marginLeft: wp('0%'),flexDirection:'column',alignItems:'center' }}>
                    ...
                    <View style={{ height: null, width: wp('43%'), marginTop: hp('3%'), marginLeft: wp('0%') ,alignItems:'center'}}>
                        ...
                        <Text style={{ textAlign: 'left', fontSize: 12, marginLeft: wp('1%'), marginBottom: hp('1%'), color: '#b4b4b4', fontFamily: 'Rubik-Bold', fontWeight: 'bold', marginTop: hp('-0.5%') }}>Order ID {itemData.id}</Text>
                    </View>
                </TouchableOpacity>
                ...
                <View style={{ marginLeft: wp('3%'),marginTop: hp('3%'), flexDirection:'column', height: null,alignItems:'center'}}>
                   ...
                   <Text style={{fontSize:12, color:'#ff914d'}}>Unpaid</Text>
                </View>
